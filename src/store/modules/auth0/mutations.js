...
export default {
  ...
  [types.AUTH0_REFRESH_TOKEN_REQUEST] (state) {
  ...
  [types.AUTH0_USER_INFO_REQUEST] (state) {

  },

  [types.AUTH0_USER_INFO_FAILURE] (state, { error }) {
    state.error = error
  },

  [types.AUTH0_USER_INFO_SUCCESS] (state, { profile }) {
    state.user = profile
    state.error = null
  }
}